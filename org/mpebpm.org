...
** Application to Census of Immune Cells
   ...
   #+BEGIN_SRC ipython :async t
     start = time.time()
     log_mu, neg_log_phi = mpebpm.sgd.ebpm_gamma(y_csr, onehot=onehot, batch_size=64, lr=5e-2, max_epochs=10, shuffle=True)
     elapsed = time.time() - start
     elapsed / 60
   #+END_SRC
   ...
   #+RESULTS:
   :RESULTS:
   0 - f7b0b12b-5d22-40a0-9aa3-e088b9762317
   :END:
