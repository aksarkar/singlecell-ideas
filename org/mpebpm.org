...
** Application to iPSCs
   ...
   Fit ~mpebpm~, and report the time elapsed in seconds.
   ...
   #+RESULTS:
   :RESULTS:
   0 - e979dff5-cd72-4b82-b83c-2cd05dcfdac7
   :END:

   For comparison, this analysis previously required approximately 7 hours
   using ~scqtl~.
