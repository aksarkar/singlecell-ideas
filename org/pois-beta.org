...
** Slice-within-Gibbs sampling
   ...
   requires the target density up to a constant. However, Kim and Marioni 2013 discuss
   an identifiability problem with the model, which was also investigated by
