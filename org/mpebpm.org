...
** Accuracy of parameter estimation
   ...
   #+BEGIN_SRC ipython :ipyfile figure/mpebpm.org/sim-1000-params.png
   ...
   :RESULTS:
   # Out[20]:
   [[file:figure/mpebpm.org/sim-1000-params.png]]
   :END:
...
** Goodness of fit
   ...
   #+BEGIN_SRC ipython :ipyfile figure/mpebpm.org/mpebpm-sim-1000-gof.png
     plt.clf()
     plt.gcf().set_size_inches(2, 2)
   ...
   :RESULTS:
   # Out[42]:
   [[file:figure/mpebpm.org/mpebpm-sim-1000-gof.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/mpebpm.org/sim-1000-params-sig.png
   ...
   :RESULTS:
   # Out[43]:
   [[file:figure/mpebpm.org/sim-1000-params-sig.png]]
   :END:
...
** Comparison to previous approach                                 :noexport:
...
** Variance within versus between individuals in iPSC data
   ...
   #+BEGIN_SRC ipython :ipyfile figure/mpebpm.org/ipsc-var-between-var-within.png
     plt.clf()
   ...
   :RESULTS:
   # Out[58]:
   [[file:figure/mpebpm.org/ipsc-var-between-var-within.png]]
   :END:
