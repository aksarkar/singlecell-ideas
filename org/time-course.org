...
* Setup
  ...
  #+RESULTS:
  : Submitted batch job 66974484

  #+CALL: ipython3(venv="singlecell",partition="mstephens",opts="-c4",memory="16G") :exports none :dir /scratch/midway2/aksarkar/ideas/
...
** Simulation
   ...
   :RESULTS:
   # Out[15]:
   [[file:figure/time-course.org/sim-topics.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/sim-fit.png
     plt.clf()
   ...
   :RESULTS:
   # Out[93]:
   [[file:figure/time-course.org/sim-fit.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/anmf-oracle-init-trace.png
     plt.clf()
   ...
   :RESULTS:
   # Out[74]:
   [[file:figure/time-course.org/anmf-oracle-init-trace.png]]
   :END:
...
** ANMF on iPSC data
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-scd.png
     plt.clf()
     plt.gcf().set_size_inches(4, 2)
   ...
   :RESULTS:
   # Out[111]:
   [[file:figure/time-course.org/ipsc-scd.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-scd-lhat.png
     plt.clf()
   ...
   :RESULTS:
   # Out[116]:
   [[file:figure/time-course.org/ipsc-scd-lhat.png]]
   :END:
...
** NMF on iPSC-CM data
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-cm-nmf-markers.png
   ...
   :RESULTS:
   # Out[264]:
   [[file:figure/time-course.org/ipsc-cm-nmf-markers.png]]
   :END:

   Trace the expression of /POU5F1/ over time.

   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-cm-POU5F1.png
   ...
   :RESULTS:
   # Out[281]:
   [[file:figure/time-course.org/ipsc-cm-POU5F1.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-cm-rep2-nmf-markers.png
   ...
   :RESULTS:
   # Out[287]:
   [[file:figure/time-course.org/ipsc-cm-rep2-nmf-markers.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/time-course.org/ipsc-cm-joint-nmf-markers.png
   ...
   :RESULTS:
   # Out[24]:
   [[file:figure/time-course.org/ipsc-cm-joint-nmf-markers.png]]
   :END:
