...
* Method
  ...
  In the M step, we can improve the likelihood by [[file:mepbpm.org][(batch) gradient
  descent]]. Alternatively, we can use an EM algorithm to solve this subproblem
